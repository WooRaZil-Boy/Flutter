...
class FeedList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // 여러개의 스크롤이 생기면서 어디까지가 스크롤 영역인지 알 수 없기 때문에 List 안에 List가 들어가면 문제가 생길 수 있다.
    return ListView.builder(
      // 따라서, shrinkWrap, physics 등의 옵션으로 어느 한 개가 스크롤이 되지 않도록 설정해야 한다.
      shrinkWrap: true,
...
class FeedItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start, // 좋아요 row를 왼쪽으로 정렬
      children: [
        Padding(
